...
public class GroupSize extends Application {
	...
	public void start(Stage primarystage) {
		...
		//This is the Group Size Application
		...
		if(numPeople>10) {
			...
			alert.setContentText("The number of people are " + numPeople + " and the group size is " + groupSize);
			alert.showAndWait();
		} else if (numPeople>=3) {
		...
		//This is the Team Size Application
		...
		if(numPeople<=55) {
			...
			Alert alert = new Alert(AlertType.INFORMATION);
			alert.setContentText("The number of players are " + numPlayers + " and the team size is " + teamSize);
			alert.showAndWait();
			...
			Alert alert = new Alert(AlertType.INFORMATION);
			alert.setContentText("The number of players are " + numPlayers + " and the team size is 1");
			alert.showAndWait();
		}
	}
}
